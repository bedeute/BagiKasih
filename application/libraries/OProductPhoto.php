...
class OProductPhoto
{
	...
	{
		return save_photo($filename,"products",array("600", "400", "200", "100", "200xcrops"), array("cropped_740x245"));
	}
	
	public function get_photo($image, $dir, $dim="200xcrops",$no_default_img=FALSE)
	{
