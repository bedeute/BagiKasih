<? if($O->row->user_id != $cu->id) redirect('user/view_orders'); ?>
<!-- mid-content -->
			...
			<div class="span9">
				<div class="content thumbnail">
					<ul class="breadcrumb">
						...
						<li><?=anchor('user/view_orders', langtext('order_history'))?> <span class="divider">/</span></li>
						<li class="active"><a><?=anchor('user/view_order_details', 'Detail')?></a></li>
					</ul>
						...
						<div class="span12">
							...
							<table class="table table-bordered table-striped">
								...
								<tfoot>
									...
									<? } ?>
									<?php if(doubleval($O->row->coup_disc) > 0) { ?>
									<tr>
