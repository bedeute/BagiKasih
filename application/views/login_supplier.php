<?=$this->load->view('tpl_sidebar')?>
    ...
    <div class="main-content">
        <h3 class="title-register">Login Supplier</h3>
        ...
        <form action="" method="post" class="register-form">
            <fieldset>
                ...
                <div class="register-link">
                	<a href="<?=site_url('account_supplier/register')?>">Register</a> | <a href="<?=site_url('account_supplier/forgot_password')?>">Lost Your Password?</a>
                </div>
            </fieldset>
        </form>  
    </div><!--.main-content-->
