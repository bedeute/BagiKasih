...
<body> 
	...
	?>
	<h3>New Order (Order ID: #<?=$order_id_new?>) </h3>
	<br />
    
    <?php $S = new OSupplier($supplier_id_new); ?>
	Dear Supplier <?=$S->row->name?>,<br /><br />
    
    Ada pesanan baru yang membutuhkan konfirmasi dari anda. Berikut adalah pesanan baru yang ada: <br /><br />
...
<br />
<strong><strong>Mohon untuk segera mengkonfirmasi kesanggupan anda dengan mengikuti halaman di bawah ini:</strong></strong><br />
<strong>Go to page <?=anchor('', 'Hapikado.com')?> or <?=anchor('account_supplier/register_login_form', 'login here')?>.</strong>
