					...
					<div class="block-content collapse in">
						...
						<?=form_open()?>
							<?php 
								...
								if($ob->row->photo_url != "")
								{
									$img_url = $ob->get_photo("200xcrops");
							...
							<table class="tbl_form">
								<tr>
									<th>Title</th>
									<td> : <input type="text" name="title" value="<?=$title?>" autofocus required /> <br/><?=form_error('title')?></td>
								</tr>
								<tr>
									<th>Photo</th>
									<td><div style="display:block;" id="preview-photo"><?=$img?></div>
										<div id="swfupload-control-photo">
											<p>Upload just 1 image files(jpg, png, gif), having maximum size of 1MB  &amp; minimum resolution 590px x 200px</p>
