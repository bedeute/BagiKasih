			...
			<div class="navbar">
				<div class="navbar-inner">
					<ul class="breadcrumb">
						...
						<li class="active">LSM Organizer List</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="span12">
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">LSM Organizer Form</div>
					</div>
					<div class="block-content collapse in">
						...
						<?=form_open()?>
							<table class="tbl_form">
								...
								<tr>
									<th>LSM</th>
									<td> : <?php echo OLsmList::drop_down_select("id_lsm",$id_lsm)?> <br/><?=form_error('id_lsm')?></td>
								</tr>
								<tr>
									<th>Name</th>
