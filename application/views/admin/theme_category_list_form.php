			...
			<div class="navbar">
				<div class="navbar-inner">
					<ul class="breadcrumb">
						...
						<li class="active">Theme Categories</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="span12">
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">Theme Categories Management</div>
					</div>
					<div class="block-content collapse in">
						...
						<?php if($showform) { ?>
							<?=form_open('', array('class' => 'form-horizontal'))?>
								<fieldset>
									<legend>
									<?php if($row) { ?>
										EDIT Theme Categories ( ID : <?=$row->id?> )
									<? } else { ?>
									...
									<table class="tbl_form">    	
										...
										<tr>         
											<td colspan="2" align="center">
												...
												<?php if($row) { ?>
												<button class="btn btn-default" type="button" onclick="location.href='<?=site_url("admin/theme_categories")?>';"><span class="leftarrow icon"></span>Cancel</button>
												<? } ?>
											</td>
										</tr>    
									</table>
						...
						<hr>
						<p>
							<strong>Filter by Category : </strong><?=anchor("admin/theme_categories/","All")?> | 
							<?php
							...
							{
								echo anchor("admin/theme_categories/?category_id={$cat->id}",$cat->name);
						...
						<?php if(sizeof($list) <= 0) { ?>
							<p class='text_red'>Theme Category List is empty.</p>
						<? } else { ?>
							<form>
								<div class="input-append">
									...
									<?=anchor('admin/theme_categories','Refresh', array('class' => 'btn'))?>
								</div>
							</form>
